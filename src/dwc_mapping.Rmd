...
Move `taxonID` to the first position (not for taxon core as metadata terms come first):

```{r}
distribution %<>% select(taxonID, everything())
species_profile %<>% select(taxonID, everything())
