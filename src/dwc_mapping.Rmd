...
# Add prefix "raw_" to all column names to avoid dwc name clashes
...
distribution %>%
gather(
  raw_presence_area, raw_presence_value,
...
mutate(
  ...
  locationID = paste0(
    "ISO3166-2:",
    recode(.$raw_presence_area, !!!term_lookup(lookup_table, "locationID"))
  ),
  locality = recode(.$raw_presence_area, !!!term_lookup(lookup_table, "locality")),
  countryCode = "BE",
  # lifeStage
...
select(-one_of(raw_colnames), -raw_presence_area, -raw_presence_value) -> distribution
