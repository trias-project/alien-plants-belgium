...
One line should represent the presence information of a species in one region or Belgium. We'll therefore transform `input_data` from a wide to a long table (i.e. create a `location` and `presence` column):
